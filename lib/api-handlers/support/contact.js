...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (insertError) {
      console.error('Failed to store support request:', insertError);
      // Continue even if DB storage fails - we still want to notify admin
    }

    // Log for admin notification (you can hook this up to email/Slack/etc later)
    console.log('═══════════════════════════════════════════════════════════');
